...
class TranslationDataModule(L.LightningDataModule):
    ...
    def filter_sentences(self, ds):
        ...
        for item in ds:
            ...
            # Check if English sentence has more than 150 tokens
            if len(src_tokens) <= 150:
                # Check if French sentence length exceeds English sentence length by more than 10 tokens
    ...
    def setup(self, stage=None):
        ...
        # Filter and update datasets
        train_ds_raw = self.filter_sentences(train_ds_raw)
        val_ds_raw = self.filter_sentences(val_ds_raw)
